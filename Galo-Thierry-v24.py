...
while True:
    ...
    if opcao == 1:
        ...
        if inputCor == 7:
            jogador1[2] = VERMELHO
            cor = "Vermelho"
        update = f"{il}Personalização efetuada : A cor do(a) {jogador1[0]} é {jogador1[2] + cor + END}"
        menuTemporario = 3
        ...
        if inputCor == 7:
            jogador2[2] = VERMELHO
            cor = "Vermelho"
        update = f"{il}Personalização efetuada : A cor do(a) {jogador2[0]} é {jogador2[2] + cor + END}"
        menuTemporario = 3

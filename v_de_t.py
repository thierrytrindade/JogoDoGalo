    ...
    if opcao == 1:
        ...
        if seriesLength > 1:
            ...
            while currentWins1 < winsNeeded and currentWins2 < winsNeeded:
                ...
                # Realiza uma partida
                resultado = jogo(galo, jogador1[1], jogador2[1], espaco, jogador1, jogador2)
                ...
                print(f"Placar da série: {jogador1[0]} {currentWins1} x {currentWins2} {jogador2[0]}\n")
            ...
            # Pergunta se o usuário deseja jogar outra série
            continuar = inputVazio("Deseja jogar outra série? (S/N): ").upper()
            if continuar != "S":
                print("Encerrando o jogo.")
                break
            else:
                # Se desejar continuar, você pode opcionalmente resetar os placares da série
                currentWins1 = 0
                currentWins2 = 0

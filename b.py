...
def mostraTabuleiro(tab):
    """Mostra o tabuleiro em formato 3x3 usando o vetor unidimensional, sem slicing."""
    for i in range(3):
        # Para cada linha, percorre as 3 colunas
        for j in range(3):
            indice = i * 3 + j  # Calcula o índice do vetor
            print(" " + tab[indice], end="")  # Imprime o elemento com um espaço antes
            if j < 2:
                print(" |", end="")  # Imprime o separador se não for o último elemento da linha
        print()  # Quebra de linha após cada linha do tabuleiro
        if i < 2:
            print("---+---+---")  # Imprime a linha separadora entre as linhas
...
def main():
    # Cria e inicializa o tabuleiro com espaços vazios
    ...
    while True:
        ...
        if op == 1:
            while True:
                ...
                # Realiza uma partida
                resultado = jogo(tabuleiro, simboloJ1, simboloJ2)
